...
function TabsAndroid() {
  return (
    <BottomTabAndroid.Navigator
      ...
      <BottomTabAndroid.Screen name="Tab2Screen" options={{tabBarLabel: 'Tab2'}} component={Tab2Screen} />
...
const TabsIOS =() => {
  return (
    ...
    >
      ...
      <BottomTabIOS.Screen name="Tab2Screen" options={{tabBarLabel: 'Tab2'}} component={Tab2Screen} />
